...
void main() {
  ...
  print("CustomFlutterBinding start");
  CustomFlutterBinding();
  print("CustomFlutterBinding end");
  runApp(MyApp());
  print("runApp(MyApp()) end");
}
...
class _MyAppState extends State<MyApp> {
  ...
  Map<String, FlutterBoostRouteFactory> routerMap = {
    '/': (settings,bool isContainer, uniqueId) {
    ...
    'mainPage': (settings,bool isContainer, uniqueId) {
      return CupertinoPageRoute(
          settings: settings,
          builder: (_) {
            return MainPage(
    ...
    'simplePage': (settings,bool isContainer, uniqueId) {
      return CupertinoPageRoute(
          settings: settings,
          builder: (_) {
  ...
  Route<dynamic>? routeFactory(RouteSettings settings, bool isInitialRoute, String? uniqueId) {
    print("FlutterBoostRouteFactory start");
    FlutterBoostRouteFactory func = routerMap[settings.name] as FlutterBoostRouteFactory;
    print("FlutterBoostRouteFactory end");
